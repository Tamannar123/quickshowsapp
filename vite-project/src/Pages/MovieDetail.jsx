...
function MovieDetail() {
  ...
  const getShow = async () => {
    const show = dummyShowsData.find(show => Number(show._id) === Number(id));
    if (show) {  setShow({ movie: show , dateTime:dummyShowsData });
    }
  ...
  return show ? (
    <div className='px-6 md:px-16 lg:px-40 pt-30 md:pt-50'>
      ...
      <p className='text-lg font-medium mt-20'>Your Favorites Cast</p>
