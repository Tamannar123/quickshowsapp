  ...
  return nowPlayingMovies.length > 0 ? (
    <>
      ...
      <div className="overflow-x-auto">
        <div className="group flex flex-wrap gap-4 mt-4 w-max">
          {nowPlayingMovies.map((movie) => (
            <div
              key={movie.id}
              className="relative max-w-[160px] cursor-pointer overflow-visible group-hover:not-hover:opacity-40 hover:translate-y-1 transition duration-300"
      ...
      <div className="mt-8">
        ...
        <div className="inline-flex items-center gap-2 border border-gray-600 px-2 rounded-md">
